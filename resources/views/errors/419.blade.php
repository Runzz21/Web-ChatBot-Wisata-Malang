...
<section class="min-h-screen flex items-center justify-center px-4" style="padding-top: 6rem;">
    <div class="text-center max-w-md">
        <p class="text-8xl sm:text-9xl font-display font-bold text-leaf-600/20">419</p>
        <h1 class="text-2xl font-display font-bold text-ink mt-4">Sesi Berakhir</h1>
        <p class="text-ink/50 mt-2">Sesi kamu telah berakhir. Silakan coba lagi.</p>
