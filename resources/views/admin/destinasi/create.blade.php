...
<div class="mb-8 reveal">
    ...
    <h1 class="text-2xl font-display font-semibold text-ink mt-1.5 tracking-tight">Tambah Destinasi</h1>
    <p class="text-ink/50 mt-1">Buat destinasi wisata alam baru</p>
</div>
