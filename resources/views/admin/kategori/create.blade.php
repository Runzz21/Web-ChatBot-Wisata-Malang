...
<div class="mb-8">
    ...
    <h1 class="text-2xl font-display font-semibold text-primary-800">Tambah Kategori</h1>
    <p class="text-[#5A6B55] mt-1">Buat kategori destinasi wisata baru</p>
</div>
    ...
    <form action="{{ route('admin.kategori.store') }}" method="POST">
        ...
        <div class="mb-5">
            ...
            <div class="flex items-center gap-3">
                <input type="color" name="warna_badge" id="warna_badge" value="{{ old('warna_badge', '#2a4f3c') }}"
                       class="w-10 h-10 rounded-xl border border-primary-200 cursor-pointer">
                <input type="text" name="warna_badge_text" id="warna_badge_text" value="{{ old('warna_badge', '#2a4f3c') }}"
        ...
        <div class="flex items-center gap-3 pt-6 border-t border-primary-200">
            <button type="submit" class="inline-flex items-center px-6 py-3 bg-accent text-white font-medium rounded-xl hover:bg-accent/90 transition-colors shadow-lereng-sm">Simpan</button>
