...
@section('content')
    ...
    <section class="relative pt-32 pb-20 lg:pb-28 overflow-hidden" style="background: #0E1D18;">
        ...
        <div class="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-lg sm:text-xl text-cream-50/60 leading-relaxed max-w-2xl mx-auto">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div class="reveal-left">
                    <span class="text-xs font-medium tracking-widest uppercase text-forest-700/40">Visi</span>
                    <h2 class="text-3xl sm:text-4xl font-display font-bold text-forest-800 mt-3 mb-6 tracking-tight">Visi Kami</h2>
                    <p class="text-forest-700/60 leading-relaxed text-lg">
                ...
                <div class="reveal-right p-8 lg:p-10 rounded-2xl" style="background: rgba(45, 74, 62, 0.03); border: 1px solid rgba(45, 74, 62, 0.06);">
                    <span class="text-xs font-medium tracking-widest uppercase text-forest-700/40">Misi</span>
                    <h2 class="text-3xl sm:text-4xl font-display font-bold text-forest-800 mt-3 mb-8 tracking-tight">Misi Kami</h2>
                    <ul class="space-y-5">
                        @foreach([
                        ...
                        <li class="flex items-start space-x-4 group">
                            <span class="flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center text-sm font-bold transition-all duration-300 group-hover:scale-105"
                                  style="background: rgba(45, 74, 62, 0.08); color: #2D4A3E;">
                                {{ $i + 1 }}
                            </span>
                            <span class="text-forest-700/60 pt-1">{{ $misi }}</span>
                        </li>
                        @endforeach
                    </ul>
                </div>
    ...
    <section class="py-16 lg:py-20 bg-cream-50/70">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto text-center reveal">
                <span class="text-xs font-medium tracking-widest uppercase text-forest-700/40">Tentang</span>
                <h2 class="text-3xl sm:text-4xl font-display font-bold text-forest-800 mt-3 mb-8 tracking-tight">Apa Itu Wisata Alam Malang?</h2>
                <div class="text-forest-700/60 leading-relaxed space-y-5 text-lg">
                    <p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-16 reveal">
                <div class="text-center">
                    <p class="text-4xl sm:text-5xl font-display font-bold text-forest-600 tracking-tight">{{ $totalDestinasi ?? '0' }}+</p>
                ...
                <div class="w-px h-12 bg-forest-600/10 hidden sm:block"></div>
                <div class="text-center">
                    <p class="text-4xl sm:text-5xl font-display font-bold text-forest-600 tracking-tight">{{ $totalKategori ?? '0' }}+</p>
                    <div class="w-8 h-[2px] bg-gold-500/60 mx-auto mt-2 mb-2"></div>
                    <p class="text-sm font-medium text-forest-700/60 tracking-wide uppercase">Kategori Wisata</p>
                </div>
                <div class="w-px h-12 bg-forest-600/10 hidden sm:block"></div>
                <div class="text-center">
                    <p class="text-4xl sm:text-5xl font-display font-bold text-forest-600 tracking-tight">{{ $totalKunjungan ?? '0' }}+</p>
                    <div class="w-8 h-[2px] bg-gold-500/60 mx-auto mt-2 mb-2"></div>
                    <p class="text-sm font-medium text-forest-700/60 tracking-wide uppercase">Kunjungan</p>
                </div>
            </div>
        </div>
    </section>
